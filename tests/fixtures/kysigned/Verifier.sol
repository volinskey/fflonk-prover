...
contract FflonkVerifier {
    uint32 constant n     = 8388608; // Domain size
    ...
    // OMEGAS
    // Omega, Omega^{1/3}
    uint256 constant w1   = 934650972362265999028062457054462628285482693704334323590406443310927365533;
    uint256 constant wr   = 5600985421709380614478435368802613598284520318496027633878954200695126540565;
    // Omega_3, Omega_3^2
    ...
    uint256 constant C0x  = 302718437049320188377154210177023634102308197538126803949691622019576023881;
    uint256 constant C0y  = 890405074548475224551320877672447891436888378197610791207612061579019791928;
